    ...
    <div className="flex flex-col flex-grow items-center justify-center text-black dark:text-white w-full h-full">
      <div className="w-full max-w-2xl h-[70vh] bg-white dark:bg-gray-800 shadow-lg rounded-lg p-4 flex flex-col">
        ...
        <div className="flex-grow overflow-y-auto space-y-3 p-2">
          {messages.length === 0 ? (
            <p className="text-center text-gray-500">Init your convo with your galactic friend</p>
          ) : (
                ...
                <ReactMarkdown
                  components={{
                    a: props => (
                      <a
                        {...props}
                        className="text-yellow-600 dark:text-yellow-400 underline hover:text-blue-800 dark:hover:text-blue-300"
                        target="_blank"
          ...
          <button
            ...
            className={`px-6 py-2 rounded-full font-semibold transition-all ${
              isThinking
                ...
                : "bg-[#FDD400] hover:bg-[#ae9724] text-black shadow-md"
            }`}
            disabled={isThinking}
          >
            Send
